...
const Dashboard = () => {
  ...
  return (
    <div className="w-full px-16 py-10 grid grid-cols-2 gap-5 ">
      {dashboardDetails.map((dashboardDetail, index) => {
        return (
          <div className="col" key={index}>
            <div
              className={`p-10 flex flex-col gap-5 mr-5 items-start rounded-md shadow-xl bg-${dashboardDetail.bgColor}-400 text-white transition hover:shadow-2xl hover:scale-105`}
            >
